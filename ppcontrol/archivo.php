                        ...
                        <div class="col-md-12">
                            <div class="card card-plain">
								...
								<td width="94%">
								    ...
								    <h4 class="title">Archivos Museo del Agua</h4>
					...
					<div id = "book_table">
						<table id = "table" class = "table table-bordered table-hover">
							...
							<tbody>
								...
								?>
								<tr>
									<td><?php echo $fbook['des_archivo']?></td>
									<td><?php echo $fbook['obs_archivo']?></td>
									<td><?php echo date("d-m-Y", strtotime($fbook['fec_archivo']))?></td>
									<td><?php echo $fbook['des_tiparchivo']?></td>
									<td><a class = "btn btn-danger delbook_id" value = "<?php echo $fbook['archivo_id']?>"><span class = "glyphicon glyphicon-remove"></span> Eliminar</a> <a value = "<?php echo $fbook['archivo_id']?>" class = "btn btn-warning ebook_id"><span class = "glyphicon glyphicon-edit"></span> Editar</a></td>
								</tr>
								<?php
									}
								?>
	...
	<script type = "text/javascript">
		$(document).ready(function(){
			...
			$('.delbook_id').click(function(){
				...
				setTimeout(function(){
					window.location = 'delete_archivo.php?book_id=' + $book_id;
				}, 1000);
			});
			$('.ebook_id').click(function(){
				...
				$('#book_table').fadeOut();
				$('#add_book').hide();
				$('#edit_form').load('load_archivo.php?book_id=' + $book_id);
			});
		});
	</script>
