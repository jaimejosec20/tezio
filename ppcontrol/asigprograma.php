                        ...
                        <div class="col-md-12">
                            <div class="card card-plain">
								...
								<td width="94%">
								    ...
								    <h4 class="title">Asignación Programas Museo del Agua</h4>
...
<form method = "POST" action = "asignacionprog.php" enctype = "multipart/form-data">
					...
					<div id = "book_table">
						<table id = "table" class = "table table-bordered table-hover">
							...
							<tbody>
								...
								?>
								<tr>
									<td width="15%"><?php echo $fbook['des_programa']?></td>
									<td width="15%"><?php echo $fbook['ver_programa']?></td>
									<td width="15%"><?php echo $fbook['pag_programa']?></td>
									<td width="50%"><?php echo $fbook['obs_programa']?></td>
									<td align="center" width="5%"><input type = "hidden" name = "programa_id[]" value = "<?php echo $fbook['id_programa']?>"><input type = "checkbox" name = "selector[]" value = "1"></td>
								</tr>
								<?php
									}
								?>
