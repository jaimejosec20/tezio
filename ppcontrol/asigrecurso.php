                        ...
                        <div class="col-md-12">
                            <div class="card card-plain">
								...
								<td width="94%">
								    ...
								    <h4 class="title">Asignación Recursos Museo del Agua</h4>
...
<form method = "POST" action = "asignacionrecs.php" enctype = "multipart/form-data">
					...
					<div id = "book_table">
						<table id = "table" class = "table table-bordered table-hover">
							...
							<tbody>
								...
								?>
								<tr>
									<td width="20%"><?php echo $fbook['des_recurso']?></td>
									<td width="45%"><?php echo $fbook['obs_recurso']?></td>
									<td width="15%"><?php echo date("d-m-Y", strtotime($fbook['fec_recurso']))?></td>
									<td width="15%"><?php echo $fbook['des_tiprecurso']?></td>
									<td align="center" width="5%"><input type = "hidden" name = "recurso_id[]" value = "<?php echo $fbook['id_recurso']?>"><input type = "checkbox" name = "selector[]" value = "1"></td>
								</tr>
								<?php
									}
								?>
