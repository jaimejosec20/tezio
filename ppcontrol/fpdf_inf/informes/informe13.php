...
$pdf->Cell(36,10,"13 JULIO 2018 ",'',0,'L',0);
$pdf->Ln(4);
$pdf->SetFont('courier','B',11);
...
$pdf->Cell(6,10,"",'',0,'L',0);
$prb=strlen("");
$pdf->MultiCell(180,5,"La experiencia CICLO DEL AGUA LUPA, se encontraron 22 conexiones Bluethooth lo cual impide que se conecte de la mejor manera al aplicativo.");
$pdf->Ln(4);
$pdf->SetFont('courier','',11);
$pdf->Cell(6,10,"",'',0,'L',0);
$prb=strlen("");
$pdf->MultiCell(180,5,"Se dejó funcionando y se eliminaron todas las conexiones Bluethooth encontradas");
...
$pdf->Image('../../images/misFotos/lupa13-07-2018/DSC_0108.jpg',60,162,105);

$pdf->Image('../../images/misFotos/lupa13-07-2018/DSC_0110.jpg',60,224,105);
...
$pdf->Image('../../images/misFotos/lupa13-07-2018/DSC_0112.jpg',60,50,105);

$pdf->Image('../../images/misFotos/lupa13-07-2018/DSC_0113.jpg',60,112,105);

$pdf->Image('../../images/misFotos/lupa13-07-2018/DSC_0115.jpg',60,174,105);
