...
$pdf->Cell(36,10,"23 JULIO 2018 ",'',0,'L',0);
$pdf->Ln(4);
$pdf->SetFont('courier','B',11);
...
$pdf->Cell(6,10,"",'',0,'L',0);
$prb=strlen("");
$pdf->MultiCell(180,5,"Se restauró el sistema operativo colocando el más antiguo. Se eliminaros todos los Bluethooth que se encontraban.");
$pdf->Ln(4);
$pdf->SetFont('courier','',11);
$pdf->Cell(6,10,"",'',0,'L',0);
$prb=strlen("");
$pdf->MultiCell(180,5,"Se dejó operativo y prendido para seguir haciendo pruebas.");
...
$pdf->Image('../../images/misFotos/lupa23-07-2018/DSC_0124.jpg',60,162,105);

$pdf->Image('../../images/misFotos/lupa23-07-2018/DSC_0122.jpg',60,224,105);
...
$pdf->Image('../../images/misFotos/lupa23-07-2018/DSC_0125.jpg',60,50,105);

$pdf->Image('../../images/misFotos/lupa23-07-2018/DSC_0126.jpg',60,112,105);

$pdf->Image('../../images/misFotos/lupa23-07-2018/DSC_0128.jpg',60,174,105);
