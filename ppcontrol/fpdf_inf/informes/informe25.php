...
$pdf->Cell(36,10,"25 JULIO 2018 ",'',0,'L',0);
$pdf->Ln(4);
$pdf->SetFont('courier','B',11);
...
$pdf->Cell(6,10,"",'',0,'L',0);
$prb=strlen("");
$pdf->MultiCell(180,5,"Se restauró el sistema, se configuró las opciones del Bluethooth, se dejó operativo y con todas las personas operándola sin problemas.");
$pdf->Ln(4);
$pdf->SetFont('courier','',11);
$pdf->Cell(6,10,"",'',0,'L',0);
$prb=strlen("");
$pdf->MultiCell(180,5,"Se recomienda verificar el cableado de la lupa ya que se ha notado que al moverla hacia arriba vuelve a activarse y queda funcionando perfectamente");
...
$pdf->Image('../../images/misFotos/lupa25-07-2018/DSC_0131.jpg',60,162,105);

$pdf->Image('../../images/misFotos/lupa25-07-2018/DSC_0133.jpg',60,224,105);
...
$pdf->Image('../../images/misFotos/lupa25-07-2018/DSC_0137.jpg',60,50,105);

$pdf->Image('../../images/misFotos/lupa25-07-2018/DSC_0136.jpg',60,112,105);

$pdf->Image('../../images/misFotos/lupa25-07-2018/DSC_0138.jpg',60,174,105);
