...
<body>
    ...
    -->
            <div class="logo">
				<img src="images/logoinvertido60.png" alt="TEZIO ::. Tecnología Interactiva" data-placement="bottom" data-html="true">
            </div>
...
<form class="form" method="post" action="indexb.php" name="fcalen" id="fcalen" onSubmit="return validarafiliado(this)">
								...
								<a href='fpdf_inf/informes/informe.php' target='_blank'><img src="images/descarga_blanca.png" border="0"></a>								</td>						
