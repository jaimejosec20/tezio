                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
                                ...
                                <div class="card-content">
                                    <p class="category">Copiar Archivos</p>
								...
								<td>
								<a href='copiararc.php' target='_blank'><img src="images/copiar2.png" border="0"></a>								</td>
						  ...
						  <div class="col-lg-3 col-md-6 col-sm-6">
                            <div class="card card-stats">
								...
								<td>
								<a href='fpdf_inf/informes/informe.php' target='_blank'><img src="images/logo_descarga_pdf.png" border="0"></a>								</td>
