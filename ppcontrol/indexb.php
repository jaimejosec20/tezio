...
//$dia1= substr($_POST["dc"], 3, 2);
//$mes1= substr($_POST["dc"], 0, 2);
//$ano1= substr($_POST["dc"], 6, 4);
...
include("paginatormensajb.inc.php"); 

//$gedit=mysqli_query($link,"SELECT idexpresumen, idtabexp, fecharegexp, tipexp, desexp, descr1exp, descr2exp, descr3exp, descr4exp, check1exp, check2exp, check3exp, check4exp, strobsexp, strdisexp FROM expresumen where fecharegexp='$fechaa11'");
                ...
                <ul class="nav">
                    <li class="active">
                        <a href="index.php">
							...
							<img src="images/administradorb.png" width="30" height="30">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-6">
						  ...
						  <div class="col-lg-6 col-md-12 col-sm-12">
                            <div class="card card-stats">
								...
								<div class="card-content">
                                    <p class="category">Descargar PDF</p>
...
<form class="form" method="post" action="indexb.php" name="fcalen" id="fcalen" onSubmit="return validarafiliado(this)">
								...
								<p class="category">Indique la Fecha</p>
								
								</td>
								<td align="center" width="48%">
								<input name="dc" type="date" id="dc">								
								</td>	
								
								<td align="center" width="22%">
								
								<a href="javascript:document.fcalen.submit();" onClick="return validarafiliado(this)"><img src="images/procesar_d.png" width="83" height="22" border="0" /></a>
								...
								<a href='fpdf_inf/informes/informe.php?fechaa1=<?PHP echo $fechaa1; ?>' target='_blank'><img src="images/descarga_blanca.png" border="0"></a>								</td>						
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-plain">
								...
								<tr>
								<td>
								<img src="images/administradorb1.png">
								</td>
								</tr>
								</table>
...
<?PHP while($rsgedit=mysqli_fetch_array($_pagi_sql)){ ?>			
