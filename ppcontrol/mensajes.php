...
$_pagi_sql = mysqli_query($link, "select menjafiliados.id_menjafiliados, menjafiliados.id_afiliados, menjafiliados.asu_menjafiliados, menjafiliados.des_menjafiliados, menjafiliados.fech_reg, menjafiliados.hora_reg, menjafiliados.lei_reg, menjafiliados.est_menjafiliados, afiliados.nombre_afiliados, afiliados.correo_afiliados, afiliados.codigoar_afiliados, afiliados.telefono_afiliados FROM menjafiliados Inner Join afiliados ON afiliados.id_afiliados = menjafiliados.id_afiliados order by menjafiliados.id_menjafiliados desc");
                        ...
                        <div class="col-md-12">
                            <div class="card card-plain">
                                <div class="card-header" data-background-color="purple">
                                    <h4 class="title">Mensajes de Afiliados</h4>
                                    <p class="category">Información Detallada de Mensajes</p>
                                </div>
...
<? while($rsgedit=mysqli_fetch_array($_pagi_result)){ ?>										
                                            <tr>
                                                <td><? echo $rsgedit[asu_menjafiliados]; ?></td>
                                                <td><? echo $rsgedit[fech_reg]; ?> / <? echo $rsgedit[hora_reg]; ?></td>
                                                <td><? echo $rsgedit[nombre_afiliados]; ?></td>
                                                <td><? echo $rsgedit[correo_afiliados]; ?></td>                                                <td>
