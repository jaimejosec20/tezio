 ...
 */
 ...
 if($_pagi_conteo_alternativo == false){//1.- ESTA ORIGINAL
	...
	$_pagi_sqlConta = "select COUNT(*) from afiliados order by id_afiliados desc";//2.- ESTA FUE CAMBIADA	
