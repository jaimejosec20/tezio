...
//**************************************************************	
	...
	//$fechaa1=date("Y-m-d");
	$_pagi_sqlConta = "select COUNT(*) from expresumen where fecharegexp='$fechaa1' order by idexpresumen desc";//2.- ESTA FUE CAMBIADA	
 ...
 */
 ...
 $_pagi_sqlLim = "SELECT idexpresumen, idtabexp, fecharegexp, tipexp, desexp, descr1exp, descr2exp, descr3exp, descr4exp, check1exp, check2exp, check3exp, check4exp, strobsexp, strdisexp FROM expresumen where fecharegexp='$fechaa1' LIMIT $_pagi_inicial,$_pagi_cuantos";
