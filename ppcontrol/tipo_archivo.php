                ...
                <ul class="nav">
                    ...
                    <li class="active">
                        <a href="tipo_archivo.php">
                            <img src="images/tipo_archivob.png" width="30" height="30">
                            &nbsp;&nbsp;&nbsp;Tipo de Archivos
                        </a>
                    </li>
                    <li>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card card-plain">
								...
								<tr>
								<td>
								<img src="images/tipo_archivob1.png">
								</td>
								</tr>
								</table>
								...
								<td width="94%">
								    ...
								    <h4 class="title">Tipo de Archivo Museo del Agua</h4>
...
<div class = "col-lg-12 well" style = "margin-top:10px;">
					...
					<div id = "book_table">
						<table id = "table" class = "table table-bordered table-hover">
							<thead>
								<tr>
									<th>Descripción Tipo de Archivo</th>
									<th>Acción</th>
								</tr>
							</thead>
							<tbody>
								<?php
									$qbook = $link->query("SELECT id_tiparchivo, des_tiparchivo, est_tiparchivo FROM tiparchivo") or die(mysqli_error());
									while($fbook = $qbook->fetch_array()){
										
								?>
								<tr>
									<td width="80%"><?php echo $fbook['des_tiparchivo']?></td>
									<td width="20%"><a class = "btn btn-danger delbook_id" value = "<?php echo $fbook['id_tiparchivo']?>"><span class = "glyphicon glyphicon-remove"></span> Eliminar</a> <a value = "<?php echo $fbook['id_tiparchivo']?>" class = "btn btn-warning ebook_id"><span class = "glyphicon glyphicon-edit"></span> Editar</a></td>
								</tr>
								<?php
									}
								?>
					...
					<div id = "book_form" style = "display:none;">
						...
						<div class = "col-lg-6">
							<form method = "POST" action = "save_tiparchivo_query.php" enctype = "multipart/form-data">
							
								<div class = "form-group">
									<label>Descripción Tipo de Archivo:</label>
									<input type = "text" name = "des_tiparchivo" required = "required" class = "form-control" />
								</div>

								<div class = "form-group">
									<button name = "save_tiparchivo" class = "btn btn-primary"><span class = "glyphicon glyphicon-save"></span> Enviar</button>
								</div>
	...
	<script type = "text/javascript">
		$(document).ready(function(){
			...
			$('.delbook_id').click(function(){
				...
				setTimeout(function(){
					window.location = 'delete_tiparchivo.php?book_id=' + $book_id;
				}, 1000);
			});
			$('.ebook_id').click(function(){
				...
				$('#book_table').fadeOut();
				$('#add_book').hide();
				$('#edit_form').load('load_tiparchivo.php?book_id=' + $book_id);
			});
		});
	</script>
