...
function stopUpload(success){
      var result = '';
      if (success == 1){
         result = '<span class="msg">¡El archivo fue cargado exitosamente!<\/span><br/>';
      }
      else {
         result = '<span class="emsg">¡Hubo un error durante la carga del archivo!<\/span><br/>';
      }
      document.getElementById('f1_upload_process').style.visibility = 'hidden';
      document.getElementById('f1_upload_form').innerHTML = result + '<label>Seleccione un Archivo: <input name="myfile" type="file" size="30" /><\/label>';
    ...
    -->
            ...
            <div class="sidebar-wrapper">
                <ul class="nav">
                    ...
                    <li class="active">
                        <a href="uploadarchivo.php">
                            <img src="images/subirb.png" width="30" height="30">
                            &nbsp;&nbsp;&nbsp;Upload Archivos
                        </a>
                    </li>					
                        ...
                        <div class="col-md-12">
                            <div class="card card-plain">
								...
								<td width="94%">
								    ...
								    <h4 class="title">Upload Archivos Museo del Agua</h4>
...
<td>
				<div class = "form-group pull-left">
						...
						<br />
						<select name = "starchivo" id = "starchivo">
							<option value = "" selected = "selected" disabled = "disabled">Seleccione una opción</option>
							<?php
								$qborrow = $link->query("SELECT * FROM tiparchivo ORDER BY des_tiparchivo") or die(mysqli_error());
								while($fborrow = $qborrow->fetch_array()){
							?>
								<option value = "<?php echo $fborrow['id_tiparchivo']?>"><?php echo $fborrow['des_tiparchivo']?></option>
							<?php
								}
							?>
						</select>
...
<td align="center" valign="middle" colspan="2">
            ...
            <div id="header_right"></div></div>
                     ...
                     <p id="f1_upload_process">Cargando...<br/><img src="loader.gif" /></p>
...
<td align="center" valign="middle" colspan="2">
					...
					<div class = "form-group pull-right">	
						<button name = "submitBtn" class = "btn btn-primary">
